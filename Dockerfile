...
RUN wget https://deb.parrot.sh/parrot/iso/5.2-1/Parrot-rootfs-5.2_amd64.tar.xz && tar -xf Parrot-rootfs-5.2_amd64.tar.xz >> Parrot.txt &
RUN curl -LO https://proot.gitlab.io/proot/bin/proot && mv proot parrot-amd64/proot && chmod +x proot && chmod 755 proot
RUN cd parrot-amd64 && wget https://github.com/tmate-io/tmate/releases/download/2.4.0/tmate-2.4.0-static-linux-amd64.tar.xz && tar -xj tmate-2.4.0-static-linux-amd64.tar.xz && rm -rf tmate-2.4.0-static-linux-amd64.tar.xz && mv tmate-2.4.0-static-linux-amd64/tmate tmate && rm -rf tmate-2.4.0-static-linux-amd64 && chmod +x tmate && chmod 755 tmate 
